...
export const responderAbi = parseAbi([
  ...
  "function setDestinationLimit(address destination, uint256 limit)",
  "function setRiskConfig(uint8 newCutoff, uint256 newDefaultLimit)",
  ...
  "function riskCutoff() view returns (uint8)",
  "function defaultTrustedLimit() view returns (uint256)",
  "function destinationLimits(address) view returns (uint256)",
